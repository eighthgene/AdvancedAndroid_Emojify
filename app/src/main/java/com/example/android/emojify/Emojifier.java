...
class Emojifier {
    ...
    private static final float SMILING_PROB_THRESHOLD = 0.15f;
    private static final float EYE_OPEN_PROB_THRESHOLD = 0.5f;
    ...
    static void detectFaces(Context context, Bitmap picture) {
        Log.i(LOG_TAG, "START DETECT MAIN: ");
    ...
    private static void whichEmoji(Face face){
        ...
        Log.i(LOG_TAG, "whichEmoji: smilingProb = " + face.getIsSmilingProbability());
        Log.i(LOG_TAG, "whichEmoji: leftEyeOpenProb = "
                + face.getIsLeftEyeOpenProbability());
        Log.i(LOG_TAG, "whichEmoji: rightEyeOpenProb = "
        ...
        Log.i(LOG_TAG, "whichEmoji: " + emoji.name());
